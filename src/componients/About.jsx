...
const About = () => {
  return (
    ...
    <p>Before you invest, you should carefully review and consider the investment objectives, risks, charges, and expenses of any mutual fund or exchange-traded fund (ETF) you are considering. ETF trading prices may not necessarily reflect the net asset value of the underlying securities. A mutual fund/ETF prospectus contains this and other information and can be obtained by emailing info@fcujetscreem.org .</p>
